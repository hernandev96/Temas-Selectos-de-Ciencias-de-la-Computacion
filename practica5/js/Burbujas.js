    ...
    function animacionBurbujas() {
        ...
        this.click = function(e){
            ...
            if (bandera) {
                ...
                var cont_aux=document.getElementById("contador");
                cont_aux.innerHTML=localStorage.getItem('cont');
               aux.setY(0);
            }
    ...
    for(i=0;i<localStorage.length;i++){
        if(localStorage.key(i)=='cont'){
            document.getElementById("contador").innerHTML=localStorage.getItem('cont');
            break;
        }
    }
